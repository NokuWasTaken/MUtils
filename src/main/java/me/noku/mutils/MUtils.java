...
import me.noku.mutils.Commands.InvSeeCommand;
import me.noku.mutils.Commands.SettingsCommand;
import me.noku.mutils.Commands.TimerCommand;
...
public final class MUtils extends JavaPlugin {
    ...
    public static String WinPrefix () { return ChatColor.GOLD + "Geschafft" + ChatColor.GRAY + " | " + ChatColor.GRAY;}
